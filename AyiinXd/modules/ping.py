...
async def _(ping):
    ...
    start = datetime.now()
    Ayiin = await edit_or_reply(ping, "**𝙀**")
    await Ayiin.edit("**𝙀𝘽**")
    await Ayiin.edit("**𝙀𝘽𝙊**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒-**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒-𝙐**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒-𝙐𝙎**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒-𝙐𝙎𝙀**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒-𝙐𝙎𝙀𝙍**")
    await Ayiin.edit("**𝙀𝘽𝙊𝙒-𝙐𝙎𝙀𝙍𝘽**")
